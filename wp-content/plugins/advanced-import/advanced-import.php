 ...
 * Description:       Easily import demo data for WordPress sites, including posts, pages, media, widgets, customizer settings, and Gutenberg Blocks with ease.
 * Version:           1.4.6
 * Author:            AddonsPress
...
define( 'ADVANCED_IMPORT_VERSION', '1.4.6' );
