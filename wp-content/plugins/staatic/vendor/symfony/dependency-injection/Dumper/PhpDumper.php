...
use Staatic\Vendor\Symfony\Component\DependencyInjection\Compiler\AnalyzeServiceReferencesPass;
use Staatic\Vendor\Symfony\Component\DependencyInjection\Compiler\CheckCircularReferencesPass;
use Staatic\Vendor\Symfony\Component\DependencyInjection\Compiler\ServiceReferenceGraphNode;
...
use Staatic\Vendor\Symfony\Component\DependencyInjection\LazyProxy\PhpDumper\NullDumper;
...
use Staatic\Vendor\Symfony\Component\DependencyInjection\Variable;
use Staatic\Vendor\Symfony\Component\ErrorHandler\DebugClassLoader;
use Staatic\Vendor\Symfony\Component\ExpressionLanguage\Expression;
use Staatic\Vendor\Symfony\Component\HttpKernel\Kernel;
class PhpDumper extends Dumper
{
    ...
    /**
     * @param DumperInterface $proxyDumper
     */
...
use Staatic\Vendor\\Symfony\\Component\\DependencyInjection\\Dumper\\Preloader;
...
EOF;
    ...
    private function generateProxyClasses(): array
    {
        ...
        foreach ($definitions as $id => $definition) {
            ...
            } while (($nullsafeVariable1 = $r) ? $nullsafeVariable1->isUserDefined() : null);
...
EOF;
    ...
    private function dumpValue($value, bool $interpolate = \true): string
    {
        if (\is_array($value)) {
            ...
            if (($nullsafeVariable2 = $this->definitionVariables) ? $nullsafeVariable2->contains($value) : null) {
