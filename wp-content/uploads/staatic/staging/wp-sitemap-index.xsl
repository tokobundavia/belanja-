			...
			<body>
				<div id="sitemap">
					<div id="sitemap__header">
						...
						<p><a href="https://www.sitemaps.org/">Pelajari lebih lanjut tentang peta situs XML.</a></p>
					</div>
					<div id="sitemap__content">
						<p class="text">Jumlah URL dalam Peta Situs XML ini: <xsl:value-of select="count( sitemap:sitemapindex/sitemap:sitemap )" />.</p>
